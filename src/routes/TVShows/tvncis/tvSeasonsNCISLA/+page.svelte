<script>
  ...
  // Season NCISLAdata stores
  let NCISLAdatas1 = writable([]);
  let NCISLAdatas2 = writable([]);
  let NCISLAdatas3 = writable([]);
  let NCISLAdatas4 = writable([]);
  let NCISLAdatas5 = writable([]);
  let NCISLAdatas6 = writable([]);
  let NCISLAdatas7 = writable([]);
  let NCISLAdatas8 = writable([]);
  let NCISLAdatas9 = writable([]);
  let NCISLAdatas10 = writable([]);
  let NCISLAdatas11 = writable([]);
  let NCISLAdatas12 = writable([]);
  let NCISLAdatas13 = writable([]);
  ...
  const unsubscribe = wsLastResponse.subscribe((response) => {
    if (response && Array.isArray(response) && currentSeason <= totalSeasons) {
      switch(currentSeason) {
        case 1: NCISLAdatas1.set(response); break;
        case 2: NCISLAdatas2.set(response); break;
        case 3: NCISLAdatas3.set(response); break;
        case 4: NCISLAdatas4.set(response); break;
        case 5: NCISLAdatas5.set(response); break;
        case 6: NCISLAdatas6.set(response); break;
        case 7: NCISLAdatas7.set(response); break;
        case 8: NCISLAdatas8.set(response); break;
        case 9: NCISLAdatas9.set(response); break;
        case 10: NCISLAdatas10.set(response); break;
        case 11: NCISLAdatas11.set(response); break;
        case 12: NCISLAdatas12.set(response); break;
        case 13: NCISLAdatas13.set(response); break;
      }
      currentSeason++;
